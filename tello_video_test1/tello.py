...
class Tello:
    ...
    """
    Change __init__ if you want to change the connection method
    """
    

    def __init__(self, local_ip, local_port, imperial=False, command_timeout=.3, tello_ip='192.168.11.7',
                 tello_port=8889):
        """
